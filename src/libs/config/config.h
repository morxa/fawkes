...
class Configuration
{
 public:
  ...
  virtual float           get_float(const char *path, const float &default_val);
  virtual unsigned int	  get_uint(const char *path, const unsigned int &default_val);
  virtual int             get_int(const char *path, const int &default_val);
  virtual bool			      get_bool(const char *path, const bool &default_val);
  virtual std::string     get_string(const char *path, const std::string &default_val);
  ...
  virtual std::vector<float>         get_floats(const char *path, const std::vector<float> &default_val);
  virtual std::vector<unsigned int>  get_uints(const char *path, const std::vector<unsigned int> &default_val);
  virtual std::vector<int>           get_ints(const char *path, const std::vector<int> &default_val);
  virtual std::vector<bool>          get_bools(const char *path, const std::vector<bool> &default_val);
  virtual std::vector<std::string>   get_strings(const char *path, const std::vector<std::string> &default_val);
