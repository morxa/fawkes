 ...
 * @return value
 *
 * @fn float Configuration::get_float(const char *path, const float &default_val)
 ...
 * @return value
 *
 * @fn unsigned int Configuration::get_uint(const char *path, const unsigned int &default_val)
 ...
 * @return value
 *
 * @fn int Configuration::get_int(const char *path, const int &default_val)
 ...
 * @return value
 *
 * @fn bool Configuration::get_bool(const char *path, const bool &default_val)
 ...
 * @return value
 *
 * @fn string Configuration::get_string(const char *path, const string &default_val)
 ...
 * @return value
 *
 * @fn std::vector<float> Configuration::get_floats(const char *path, const std::vector<float> &default_val)
 ...
 * @return value
 *
 * @fn std::vector<unsigned int> Configuration::get_uints(const char *path, const std::vector<unsigned int> &default_val)
 ...
 * @return value
 *
 * @fn std::vector<int> Configuration::get_ints(const char *path, const std::vector<int> &default_val)
 ...
 * @return value
 *
 * @fn std::vector<bool> Configuration::get_bools(const char *path, const std::vector<bool> &default_val)
 ...
 * @return value
 *
 * @fn std::vector<string> Configuration::get_strings(const char *path, const std::vector<string> &default_val)
...
float
Configuration::get_float(const char *path, const float &default_val)
{
  try {
...
unsigned int
Configuration::get_uint(const char *path, const unsigned int &default_val)
{
  try {
...
int
Configuration::get_int(const char *path, const int &default_val)
{
  try {
    return get_int(path);
  } catch (ConfigEntryNotFoundException & e) {
...
bool
Configuration::get_bool(const char *path, const bool &default_val)
{
  try {
...
std::string
Configuration::get_string(const char *path, const std::string &default_val)
{
  try {
...
std::vector<float>
Configuration::get_floats(const char *path, const std::vector<float> &default_val)
{
  try {
...
Configuration::get_uints(const char *path, const std::vector<unsigned int> &default_val)
{
  try {
...
std::vector<int>
Configuration::get_ints(const char *path, const std::vector<int> &default_val)
{
  try {
...
std::vector<bool>
Configuration::get_bools(const char *path, const std::vector<bool> &default_val)
{
  try {
...
Configuration::get_strings(const char *path, const std::vector<std::string> &default_val)
{
  try {
